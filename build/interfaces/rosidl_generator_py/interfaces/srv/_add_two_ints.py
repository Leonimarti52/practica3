...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from interfaces.srv._add_two_ints import AddTwoInts_Request as Request
    from interfaces.srv._add_two_ints import AddTwoInts_Response as Response
