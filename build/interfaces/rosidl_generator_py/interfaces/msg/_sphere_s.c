...
bool interfaces__msg__sphere__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._sphere.Sphere", full_classname_dest, 29) == 0);
  }
  interfaces__msg__Sphere * ros_message = _ros_message;
  {  // radius
...
PyObject * interfaces__msg__sphere__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._sphere");
